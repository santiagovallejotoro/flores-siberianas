...
const Footer = () => {
  ...
  return (
    <>
      <footer className="relative z-10 bg-foreground pt-16 dark:bg-foreground md:pt-20 lg:pt-24">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="space-y-2 text-sm text-white/70">
                  ...
                  <p>
                    <a href="tel:+573127809601" className="text-primary-300 hover:text-primary-200">
                      {t.footer.phone}
                    </a>
                  </p>
                  <p>
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                ...
                <div className="flex gap-4">
                  <a
                    href={`https://wa.me/573127809601?text=${encodeURIComponent(t.footer.whatsappPrefilled)}`}
                    target="_blank"
                  ...
                  <a
                    href="https://www.facebook.com/profile.php?id=100077965028773"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-white/70 duration-300 hover:text-primary-300"
                    aria-label="Facebook"
